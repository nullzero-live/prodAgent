...
def tasks(query):
    template = """You are a professional project manager. You are building a business marketing case. You take an objective and break it into steps. A maximum of 10. You will write them in a list by highest priority:
